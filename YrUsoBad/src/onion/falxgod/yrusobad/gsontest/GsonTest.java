...
public class GsonTest {
	public static void main(String[] args) {
		...
		stats.add("charge impact", new JsonPrimitive(233));
		stats.add("impact damage", new JsonPrimitive(140));
		stats.add("melee attack", new JsonPrimitive(89));
		stats.add("melee attack", new JsonPrimitive(142));
		stats.add("melee weapon damage", new JsonPrimitive(58));
		stats.add("melee weapon penetration damage", new JsonPrimitive(77));
		stats.add("morale flank damage", new JsonPrimitive(181));
		stats.add("charge deflect", new JsonPrimitive(33));
		stats.add("missile block chance", new JsonPrimitive(22));
		stats.add("body armour", new JsonPrimitive(104));
		...
		stats.add("movement speed", new JsonPrimitive(4.4));
		stats.add("turn speed", new JsonPrimitive(392));
		stats.add("view range", new JsonPrimitive(181));
